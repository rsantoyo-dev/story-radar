...
const VISUAL_NEED_INSTRUCTION = `\n\nFor every unit, also return visualNeed, exactly one of "verified-map", "real-photo", "character-reference", "generic-illustration" or "typography". Return no other value.
