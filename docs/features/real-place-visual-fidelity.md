...
Pendiente: geometrías MultiLineString, comunicados que citen varias rutas cerradas bajo chantiers distintos (hoy: ambiguo, sin mapa) y un reintento programado de la preparación cuando el feed publique la ventana anunciada.
